...
class ValueType:
    ...
    ARRAY = "array"  # New
    OBJECT = "object"  # New
    LIST = "array"  # LIST as alias for ARRAY
...
class Property:
    ...
    async def get_state_value(self):
        ...
        # If first time calling getter, determine type
...
class Method:
    def __init__(
        ...
        # Force callback function to be async function
    ...
    async def invoke(self, params: Dict[str, Any]) -> Any:
        ...
        for name, value in params.items():
            if name in self.parameters:
                ...
                # If parameter type is STRING but value is dict or list, convert to JSON string (similar to C++ version)
